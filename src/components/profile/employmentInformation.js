...
function EmploymentInformation() {
    ...
    return (
        <div className="flex-col">
            <Card className="px-4 pt-4 mb-4">
                <div className="grid-cols-3 gap-4 mb-4 text-sm lg:grid">
                    <FormControl
                        control="select"
                        label="Training Batch"
                        name="batch"
                        options={batch}
                        errors={formik.errors.batch}
                    ...
                    <FormControl
                        ...
                        errors={formik.errors.wiresign}
                        touched={formik.touched.wiresign}
                        label="Wiresign"
                    />
                    <FormControl
                        control="input"
                        ...
                        label="Date Employed"
                        name="dateEmployed"
                        errors={formik.errors.dateEmployed}
                        touched={formik.touched.dateEmployed}
                        placeholder="YYYY-MM-DD"
                    />
                </div>
                <div className="grid-cols-3 gap-4 text-sm lg:grid">
                    <div className="relative flex flex-col justify-center">
                        <h6 className="mb-1">License Number</h6>
                        <div className="flex flex-row items-center w-full mb-4">
                            <span
                                className={`block border-2 p-4 border-gray-300 border-r-0 bg-gray-200 text-gray-600 rounded-l-lg ${
                    ...
                    <FormControl
                        ...
                        errors={formik.errors.ATCLicenseExpiry}
                        touched={formik.touched.ATCLicenseExpiry}
                        placeholder="YYYY-MM-DD"
                    />
                    <FormControl
                        control="input"
                        ...
                        errors={formik.errors.medicalLicenseExpiry}
                        touched={formik.touched.medicalLicenseExpiry}
                        placeholder="YYYY-MM-DD"
                    />
                </div>
            </Card>
                    ...
                    {({ form, push, remove }) => {
                        ...
                        return (
                            <>
                                ...
                                {facilitiesArray.map(
                                    ({ facility, to, from }, index) => {
                                        return (
                                            <Card
                                                colored={
                                                    errors.facility && true
                                                }
                                                className={`lg:grid grid-cols-12 pt-2 px-2 mb-4 flex flex-col w-full ${
                                                    errors.facility
                                                    ...
                                                    <div className="mb-4 lg:mb-0">
                                                        ...
                                                        <FormControl
                                                            options={renderAreaOptions(
                                                                facility
                                                            )} // facility map param {facility} only used here
                                                            control="select"
